...
export declare const addScheduleEvent: (req: AuthenticatedRequest, res: Response<ApiResponse<Classroom>>, next: NextFunction) => Promise<void>;
export declare const gradeSubmission: (req: AuthenticatedRequest, res: Response<ApiResponse<Classroom>>, next: NextFunction) => Promise<void>;
export declare const submitAssignment: (req: AuthenticatedRequest, res: Response<ApiResponse<Classroom>>, next: NextFunction) => Promise<void>;
